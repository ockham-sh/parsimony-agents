...
import pandas as pd
from ockham.result import Provenance
...
from ockham_agents.execution.pagination import TablePaginator, get_output_header
from ockham_agents.messages import MessageContent
from ockham_agents.theme import OCKHAM_FIGURE_HEIGHT, OCKHAM_FIGURE_WIDTH
from ockham_agents.util import truncate_text
...
def finalize_spec(spec: dict) -> dict:
    """Apply Ockham default sizing/autosize rules to a spec dict."""
    spec["width"] = OCKHAM_FIGURE_WIDTH
    spec.setdefault("height", OCKHAM_FIGURE_HEIGHT)
...
class PrimitiveObject(BaseOutputObject):
    ...
    def to_llm(self, mode="default", overrides: dict[str, Any] = {}):
        ...
        from ockham_agents.execution.pagination import StringPaginator
