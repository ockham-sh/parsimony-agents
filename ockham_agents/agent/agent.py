...
from ockham_agents.notebook import Script
...
from ockham_agents.artifacts import (
    Chart,
    Dataset,
)
from ockham_agents.execution import (
    DataFrameObject,
    ExceptionObject,
    FigureObject,
    PrimitiveObject,
...
from ockham_agents.execution.executor import BaseCodeExecutor
from ockham_agents.execution.factory import OutputFactory as FrameworkOutputFactory
from ockham_agents.messages import Message, Text, blocks_to_text
from ockham_agents.rag.keyword_store import get_or_create_session_keyword_store
from ockham_agents.rag.vector_store import get_or_create_session_vector_store
from ockham_agents.tools import Tools, toolmethod
from ockham_agents.variable import Variable, VariableStore
from ockham_agents.views import get_llm_view_defaults

logger = logging.getLogger("ockham_agents")
error_logger = logging.getLogger("ockham_agents.errors")
    ...
    **Power usage (product / full control):**
    ...
    def __init__(
        ...
        *,
        ...
        from ockham_agents.execution.executor import CodeExecutor as _LocalExecutor
        ...
        output_factory = (
            ...
            or FrameworkOutputFactory(local_dir=tempfile.mkdtemp(prefix="ockham_agent_"))
        )
    ...
    async def output_search(self, *, query: str, variable_name: str | None = None, top_k: int = 5, context: AgentContext) -> SystemToolOutput:
        ...
        from ockham_agents.rag import hybrid_search
