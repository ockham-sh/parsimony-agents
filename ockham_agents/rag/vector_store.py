...
from ockham_agents.rag.embeddings import embed_texts

if TYPE_CHECKING:
    from ockham_agents.execution.outputs import DataFrameObject, PrimitiveObject
...
class SessionVectorStore:
    ...
    def _get_processor(self) -> Any:
        if self._output_processor is None:
            from ockham_agents.rag.processors import OutputProcessor
